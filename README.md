...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>🧠 EduGraph</h3>
      <p><i>Multi-agent generative learning platform</i></p>
      <p>Automates the creation of custom learning paths — from course structuring to interactive assessment generation — through a coordinated system of specialized AI agents.</p>
      <p>
      ...
      <a href="https://github.com/zinebni/EduGraph"><img src="https://img.shields.io/badge/View_Repo-181717?style=flat-square&logo=github&logoColor=white"/></a>
    </td>
    <td width="50%" valign="top">
      <h3>📄 SmartDoc</h3>
      <p><i>Local RAG research assistant</i></p>
      <p>Lets users import documents into notebooks to auto-generate summaries and query their content through a fully local Retrieval-Augmented Generation pipeline.</p>
      <p>
        <img src="https://img.shields.io/badge/React-20232A?style=flat-square&logo=react&logoColor=61DAFB"/>
        <img src="https://img.shields.io/badge/Spring_Boot-6DB33F?style=flat-square&logo=spring-boot&logoColor=white"/>
        <img src="https://img.shields.io/badge/ChromaDB-FF6F61?style=flat-square"/>
        <img src="https://img.shields.io/badge/TinyLlama-000000?style=flat-square"/>
      </p>
      <a href="https://github.com/zinebni/SmartDoc"><img src="https://img.shields.io/badge/View_Repo-181717?style=flat-square&logo=github&logoColor=white"/></a>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>A clean multi-layered Android app targeting SDK 34, with local persistence via Room DB, pre-populated default categories, reactive state flows, and dependency injection.</p>
      <p>
        <img src="https://img.shields.io/badge/Kotlin-7F52FF?style=flat-square&logo=kotlin&logoColor=white"/>
        <img src="https://img.shields.io/badge/Jetpack_Compose-4285F4?style=flat-square&logo=jetpackcompose&logoColor=white"/>
        <img src="https://img.shields.io/badge/Hilt-1DB954?style=flat-square"/>
    ...
    <td width="50%" valign="top">
      ...
      <p>An interactive Angular app fetching users from the RandomUser API, applying RxJS observables to filter and transform streams in real time, and computing proximity via the Haversine formula.</p>
      <p>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>A full-stack app built in pure Java EE without Spring or <code>@Transactional</code> — strict MVC separation, custom Servlet filter security, and explicit manual JPA transaction management.</p>
      <p>
        <img src="https://img.shields.io/badge/Java_EE-ED8B00?style=flat-square&logo=openjdk&logoColor=white"/>
        <img src="https://img.shields.io/badge/JPA_%2F_Hibernate-59666C?style=flat-square"/>
    ...
    <td width="50%" valign="top">
      ...
      <p><i>Solidity smart contract for secure e-voting</i></p>
      <p>A transparent Ethereum smart contract system where a Chairman adds candidates, each wallet gets a single verifiable on-chain vote, and the winner is immutably computed on close.</p>
      <p>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <a href="https://github.com/zinebni/fleur-atelier"><img src="https://img.shields.io/badge/View_Repo-181717?style=flat-square&logo=github&logoColor=white"/></a>
    </td>
    <td width="50%" valign="top">
      <h3>⏱️ Smart Queue</h3>
      <p><i>Real-time queue management system</i></p>
      <p>Digitizes physical waiting lines for high-traffic services, with live position updates delivered to users via real-time notifications.</p>
      <p>
        <img src="https://img.shields.io/badge/Angular-DD0031?style=flat-square&logo=angular&logoColor=white"/>
  ...
  <tr>
    <td colspan="2" valign="top">
      ...
      <p>
        ...
        <img src="https://img.shields.io/badge/Laravel_Breeze-FF2D20?style=flat-square"/>
